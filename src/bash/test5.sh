...
jq '..|select(contains("https://data.vlaanderen.be/ns/perceel#RuimtelijkeEenheid")?)' ../source/omgevingsvergunning-ap.jsonld

sparql --data=../main/resources/be/vlaanderen/data/id/applicatieprofiel/omgevingsvergunning/omgevingsvergunning-ap-SHACL.ttl --query ../sparql/test5.rq --results=CSV
